...
- [ ] Remplacer les icônes emoji par une vraie librairie SVG dans le reste de l'app (chantier transverse, ~68 fichiers restants) — tab bar athlète + nav principale coach déjà faites (Phosphor, 2026-09-04).
