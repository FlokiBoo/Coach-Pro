...
export const MUSCLE_GROUPS = [
  ...
  { n: 5, key: 'cou', label: 'Cou', color: '#F43F5E' },
  { n: 6, key: 'biceps', label: 'Biceps', color: '#F59E0B' },
  { n: 7, key: 'triceps', label: 'Triceps', color: '#EAB308' },
  { n: 8, key: 'abdominaux', label: 'Abdominaux', color: '#84CC16' },
  { n: 9, key: 'obliques', label: 'Obliques', color: '#22C55E' },
  { n: 10, key: 'trapèzes', label: 'Trapèzes', color: '#10B981' },
  { n: 11, key: 'grand dorsal', label: 'Grand dorsal', color: '#14B8A6' },
  { n: 12, key: 'lombaires', label: 'Lombaires', color: '#06B6D4' },
  { n: 13, key: 'fessiers', label: 'Fessiers', color: '#0EA5E9' },
  { n: 14, key: 'quadriceps', label: 'Quadriceps', color: '#3B82F6' },
  { n: 15, key: 'adducteurs', label: 'Adducteurs', color: '#6366F1' },
