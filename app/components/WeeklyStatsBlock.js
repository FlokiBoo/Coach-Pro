...
export default function WeeklyStatsBlock({ athleteId, refreshKey }) {
  ...
  // Une fois semaine/mois chargés une première fois à offset 0, on les garde en cache pour que
  // les allers-retours manuels suivants s'affichent instantanément, sans repasser par un état
  // de chargement qui ferait sauter la page.
  useEffect(() => {
    if (!athleteId) return
